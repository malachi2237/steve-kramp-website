/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2075ce43b0a040222f0d61ff56c0f23e)
// Runtime types generated with workerd@1.20260128.0 2026-01-10 
declare namespace Cloudflare {
	interface ProductionEnv {
		domain: "stevekramp.com";
		FORM_KEY: string;
		TURNSTILE_SECRET_KEY: string;
		TURNSTILE_PUBLIC_KEY: string;
		SONICJS_API_URL: string;
		FORM_SUBMIT: Fetcher /* form-relay */;
	}
	interface PreviewEnv {
		domain: "dev.steve-kramp-website.pages.dev";
		FORM_KEY: string;
		TURNSTILE_SECRET_KEY: string;
		TURNSTILE_PUBLIC_KEY: string;
		SONICJS_API_URL: string;
	...
	interface Env {
		...
		TURNSTILE_PUBLIC_KEY: string;
		SONICJS_API_URL: string;
		domain?: "stevekramp.com" | "dev.steve-kramp-website.pages.dev";
		FORM_SUBMIT?: Fetcher /* form-relay */;
	}
}
